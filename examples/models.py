...
# we are advised to atleast inherit the abstractUser model instead.
...
class Driver(User):
    # connect the driver manager to the driver model
...
# finally instead of overriding save() we can create a variable in our base user model
...
# in the end we now have spy user, driver user and admin user. 
# the admin user can change driver to spy and vice versa!